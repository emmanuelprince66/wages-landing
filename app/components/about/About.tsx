    ...
    <div className="flex-1 rounded-[12px] bg-white p-3 flex items-start gap-3">
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-primary_gray text-[15px] font-[400] leading-[30px]">
          We are a cooperative platform that empowers you to achieve your financial goals.
          WagesFinance simplifies your financial journey. We make it easier to manage your
